...
__title__ = "FreeCAD FEM body constraint body source ViewProvider"
...
class _TaskPanel:
    '''The editmode TaskPanel for FemBodySource objects (FemBodySource and FemInitialValue)'''

    def __init__(self, obj):
        self.obj = obj

        self.BodyConstraintSettings = self.obj.BodySource
        self.BodyConstraintSettings['Category'] = 'BodySource'
        self.BodyConstraintSettings['ShapeType'] = self.obj.ShapeType
    ...
    def accept(self):
        ...
        if self.selectionWidget.has_equal_references_shape_types():
            ...
            self.obj.BodySource = self.parameterWidget.bodyConstraintSettings()
