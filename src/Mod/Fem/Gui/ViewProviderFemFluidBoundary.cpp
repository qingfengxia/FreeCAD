...
PROPERTY_SOURCE(FemGui::ViewProviderFemFluidBoundary, FemGui::ViewProviderFemConstraint)


ViewProviderFemFluidBoundary::ViewProviderFemFluidBoundary()
{
...
bool ViewProviderFemFluidBoundary::setEdit(int ModNum)
{
    if (ModNum == ViewProvider::Default ) {
        ...
        TaskDlgFemFluidBoundary *constrDlg = qobject_cast<TaskDlgFemFluidBoundary *>(dlg);
        ...
        if (dlg && !constrDlg) {
            ...
            if ((wizardWidget == NULL) || (wizardSubLayout == NULL)) {
                ...
                constraintDialog = new TaskFemFluidBoundary(this);
                return true;
            }
        }
        ...
        if (constrDlg)
            ...
            Gui::Control().showDialog(new TaskDlgFemFluidBoundary(this));
...
void ViewProviderFemFluidBoundary::updateData(const App::Property* prop)
{
    // Gets called whenever a property of the attached object changes
    Fem::FluidBoundary* pcConstraint = static_cast<Fem::FluidBoundary*>(this->getObject());
    ...
    if (boundaryType == "inlet" || boundaryType == "outlet"){
        //Base::Console().Message("\n BoundaryType property in ViewProviderFemFluidBoundary::updateData \n");
