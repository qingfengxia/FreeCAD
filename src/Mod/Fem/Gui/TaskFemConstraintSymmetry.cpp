...
#include "ui_TaskFemConstraintSymmetry.h"
#include "TaskFemConstraintSymmetry.h"
...
#include <Mod/Fem/App/FemConstraintSymmetry.h>
...
/* TRANSLATOR FemGui::TaskFemConstraintSymmetry */

TaskFemConstraintSymmetry::TaskFemConstraintSymmetry(ViewProviderFemConstraintSymmetry *ConstraintView,QWidget *parent)
    : TaskFemConstraint(ConstraintView, parent, "fem-constraint-Symmetry")
{
    // we need a separate container widget to add all controls to
    proxy = new QWidget(this);
    ui = new Ui_TaskFemConstraintSymmetry();
    ui->setupUi(proxy);
    ...
    Fem::ConstraintSymmetry* pcConstraint = static_cast<Fem::ConstraintSymmetry*>(ConstraintView->getObject());
...
void TaskFemConstraintSymmetry::onSelectionChanged(const Gui::SelectionChanges& msg)
{
...
void TaskFemConstraintSymmetry::onReferenceDeleted() {
...
const std::string TaskFemConstraintSymmetry::getReferences() const
{
...
TaskFemConstraintSymmetry::~TaskFemConstraintSymmetry()
{
    delete ui;
}

void TaskFemConstraintSymmetry::changeEvent(QEvent *e)
{
...
TaskDlgFemConstraintSymmetry::TaskDlgFemConstraintSymmetry(ViewProviderFemConstraintSymmetry *ConstraintView)
{
    this->ConstraintView = ConstraintView;
    assert(ConstraintView);
    this->parameter = new TaskFemConstraintSymmetry(ConstraintView);;
...
bool TaskDlgFemConstraintSymmetry::accept()
{
    return TaskDlgFemConstraint::accept();
}

#include "moc_TaskFemConstraintSymmetry.cpp"
